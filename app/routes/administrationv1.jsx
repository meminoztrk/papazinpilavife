...
export default function Admin() {
  ...
  const items = [
    getItem(
      <Link to="/administrationv1">Gösterge Paneli</Link>,
      "administrationv1",
      <PieChartOutlined />
    ),
    ...
    getItem(
      <Link to="/administrationv1/incelemeler">İncelemeler</Link>,
      "incelemeler",
      <CommentOutlined />
    ),
    getItem(
    ...
    getItem(
      <Link to="/administrationv1/yazarlar">Kuryeler</Link>,
      "kuryeler",
      <BsBicycle />
    ),
    getItem("Şikayetler", "sikayetler", <FileSearchOutlined />, [
      getItem(
        <Link className="text-xs" to="/administrationv1/koseyazilari">
          İşletme Şikayetleri
        </Link>,
        "koseyazilari"
      ),
      getItem(
        <Link
          className="text-xs"
          to="/administrationv1/koseyazilari/yenikoseyazisi"
        >
          İnceleme Şikayetleri
        </Link>,
        "yenikoseyazisi"
      ),
    ]),
    getItem(
      <Link to="/administrationv1/yorumlar">Yorumlar</Link>,
      "yorumlar",
      <Badge dot={true}>
    ...
    getItem(
      <Link to="/administrationv1/kimlik">Kimlik</Link>,
      "kimlik",
      <MediumOutlined />
    ),
    getItem(
      <Link to="/administrationv1/galeri">Galeri</Link>,
      "galeri",
      <PictureOutlined />
    ),
    getItem(
      <Link to="/administrationv1/ayarlar">Ayarlar</Link>,
      "ayarlar",
      <SettingOutlined />
    ),
  ...
  return (
    <div>
      <Layout style={{ minHeight: "100vh" }}>
        ...
        >
          <div className="m-4 p-1 text-center flex justify-center">
            <h1 className="font-extrabold text-lg text-white flex items-center space-x-2 underline text-center">
              <ControlOutlined />
              {!collapse && <span>Administration</span>}
            </h1>
            {/* <div className="logo" /> */}
          </div>
          {/* <span>{!collapse && "Administration"}</span> */}
          <Menu
            theme="dark"
            className="text-xs"
            selectedKeys={[origin]}
        ...
        <Layout className="site-layout" style={{ width: "1500px" }}>
          ...
          <Footer style={{ textAlign: "center" }}>Administration V1</Footer>
        </Layout>
      </Layout>
    </div>
  );
