...
import { useFavoriteComment } from "~/components/useInfiniteScrolling";
...
const begenilenyorumlar = () => {
  ...
  const { comments, setComments, hasMore, loading, error } = useFavoriteComment(
    userProfile.userId,
    pageNumber,
    API,
    API_KEY
...
export default begenilenyorumlar;
